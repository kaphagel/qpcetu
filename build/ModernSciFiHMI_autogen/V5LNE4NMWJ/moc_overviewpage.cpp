...
#include <memory>
#include "../../../src/pages/overviewpage.h"
...
QT_MOC_LITERAL(1, 13, 11), // "iconClicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "pageIndex"
QT_MOC_LITERAL(4, 36, 14) // "onThemeChanged"

    },
    "OverviewPage\0iconClicked\0\0pageIndex\0"
    "onThemeChanged"
};
...
void OverviewPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->iconClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (OverviewPage::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OverviewPage::iconClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OverviewPage::iconClicked(int _t1)
{
