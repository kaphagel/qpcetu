...
ControllerStateMachine::ControllerStateMachine(const QString &controllerIp, QObject *parent)
    : QObject(parent), m_stateMachine(new QStateMachine(this)), m_heartbeatTimer(new QTimer(this)), m_controllerIp(controllerIp), m_currentState(Disconnected)
{
